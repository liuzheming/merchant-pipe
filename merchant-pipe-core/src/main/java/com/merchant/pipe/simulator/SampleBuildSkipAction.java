 ...
 */
@Slf4j
public class SampleBuildSkipAction extends AbsAction<Map<String, Object>, Map<String, Object>> {

    public SampleBuildSkipAction() {
        super();
    }

    @Override
    protected Map<String, Object> buildParam() {
        throw new ActionSkipException("haha, skip this action");
    }
